### Auto-generated HTML & Javascript for Cmajor Patch "Logical Chaos Melody Machine"
...
- `cmaj_Logical_Chaos_Melody_Machine.js` - this is the Javascript wrapper class for the patch, encapsulating its
