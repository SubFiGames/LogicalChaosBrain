...
<head>
    <style>
        body { background: #0b0b0b; color: #00ffaa; font-family: 'Courier New', monospace; text-align: center; }
        #canvas { border: 2px solid #333; border-radius: 50%; margin: 20px; transition: 0.3s; }
        .drag-zone { width: 150px; height: 50px; border: 1px solid #00ffaa; margin: auto; line-height: 50px; cursor: grab; background: rgba(0,255,170,0.1); }
    </style>
</head>
<body>
    <h2>LOGICAL CHAOS</h2>
    <canvas id="canvas" width="200" height="200"></canvas>
    <div id="drag-zone" class="drag-zone" draggable="true">DRAG CLIP TO DAW</div>
    <p>Chaos Amount</p>
    <input type="range" id="chaos-slider" min="0" max="100" style="width: 80%;">
